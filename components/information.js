...
const Information = () => {
    ...
    var settings = {
      ...
      return (
        <div>
            <h1 className="text-3xl font-bold mt-2 flex justify-center mb-6">Malaria Information</h1>

            <div className='flex justify-center'>
        
                <div
                    className='md:col-span-2 relative md:h-[70vh] h-[50vh] m-4 mt-4 w-[90vw] md:w-[90vw] p-8 border rounded-lg bg-gray-300 z-0'
                    // style={{
                    //     width: "1080px",
                    //     height: "500px",
                    // //   padding: "20px",
